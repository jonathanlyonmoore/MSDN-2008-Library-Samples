...
{
public:
	DECLARE_PERF_CATEGORY(CSamplePerformanceObject, 1, _T("PerformanceCounterSample"), _T("PerformanceObjectHelpStr"), -1);
...
#define Perf_PerfObjMgr _T("Perf_PerformanceCounter")
	BEGIN_PERF_MAP(Perf_PerfObjMgr)
		CHAIN_PERF_CATEGORY(CSamplePerformanceObject)
	END_PERF_MAP()
