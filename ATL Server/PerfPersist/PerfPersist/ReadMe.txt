========================================================================
       ATL SERVER : PerfPersist Project Overview
========================================================================

AppWizard has created this PerfPersist application for you.  This application
not only demonstrates the basics of using the ATL Server Classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your PerfPersist application.
...
PerfPersist.srf
	...
	associated with the OnHello method in the CPerfPersistHandler class.
