...
// Security Issue: The connection strings containing hard-coded passwords could be a security risk. Replace placeholder for PWD parameter in line below."
#define CONNECTION_STRING L"Provider=Microsoft.Jet.OLEDB.4.0;User ID=Admin;Data Source=C:\\tutorial\\tutorial.mdb;Mode=Share Deny None;Extended Properties=\"\";Jet OLEDB:System database=\"\";Jet OLEDB:Registry Path=\"\";Jet OLEDB:Database Password=\"<password placeholder>\";Jet OLEDB:Engine Type=5;Jet OLEDB:Database Locking Mode=1;Jet OLEDB:Global Partial Bulk Ops=2;Jet OLEDB:Global Bulk Transactions=1;Jet OLEDB:New Database Password=\"\";Jet OLEDB:Create System Database=False;Jet OLEDB:Encrypt Database=False;Jet OLEDB:Don't Copy Locale on Compact=False;Jet OLEDB:Compact Without Replica Repair=False;Jet OLEDB:SFP=False"