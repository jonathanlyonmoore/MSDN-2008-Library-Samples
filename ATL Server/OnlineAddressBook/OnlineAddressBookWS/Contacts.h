...
public:
	...
	[ db_column(ordinal = "1")] TCHAR m_Birthday[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "2")] TCHAR m_BusinessCity[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "3") ] TCHAR m_BusinessCountry[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "4") ] TCHAR m_BusinessFax[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "5") ] TCHAR m_BusinessPhone[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "6") ] TCHAR m_BusinessPostalCode[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "7") ] TCHAR m_BusinessState[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "8") ] TCHAR m_BusinessStreet[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "9") ] TCHAR m_Company[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "10") ] LONG m_ContactID;
	[ db_column(ordinal = "11") ] TCHAR m_Department[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "12") ] TCHAR m_EmailAddress[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "13") ] TCHAR m_FirstName[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "14") ] TCHAR m_HomeCity[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "15") ] TCHAR m_HomeCountry[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "16") ] TCHAR m_HomeFax[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "17") ] TCHAR m_HomePhone[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "18") ] TCHAR m_HomePostalCode[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "19") ] TCHAR m_HomeState[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "20") ] TCHAR m_HomeStreet[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "21") ] TCHAR m_JobTitle[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "22") ] TCHAR m_LastName[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "23") ] TCHAR m_MiddleName[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "24") ] TCHAR m_MobilePhone[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "25") ] TCHAR m_OtherPhone[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "26") ] TCHAR m_Suffix[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "27") ] TCHAR m_Title[DB_MAX_CONTACT_FIELDLEN + 1];
	[ db_column(ordinal = "28") ] LONG m_UserID;
	[ db_column(ordinal = "29") ] TCHAR m_WebPage[DB_MAX_CONTACT_FIELDLEN + 1];
