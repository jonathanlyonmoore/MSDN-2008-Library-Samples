========================================================================
       ATL SERVER : OnlineAddressBookSRF Project Overview
========================================================================

AppWizard has created this OnlineAddressBookSRF application for you.  This application
not only demonstrates the basics of using the ATL Server Classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your OnlineAddressBookSRF application.

OnlineAddressBookSRF.vcproj
    This is the main project file for VC++ projects generated using an Application Wizard. 
    It contains information about the version of Visual C++ that generated the file, and 
    information about the platforms, configurations, and project features selected with the
    Application Wizard.
OnlineAddressBookSRFDeploy.vdproj
...
OnlineAddressBookSRF.cpp
OnlineAddressBookSRF.h
...
OnlineAddressBookSRF.srf
	...
	associated with the OnHello method in the COnlineAddressBookSRFHandler class.
