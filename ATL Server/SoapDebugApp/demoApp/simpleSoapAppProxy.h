...
{
	static const _soapmapentry __CSimpleSoapAppService_HelloWorld_atlsoapheader_entries[] =
	{
		{ 0x00000000 }
	};

	static const _soapmap __CSimpleSoapAppService_HelloWorld_atlsoapheader_map = 
	{
		0x46BA99FC,
		"HelloWorld",
		L"HelloWorld",
	...
	static const _soapmap * __CSimpleSoapAppService_headers[] =
	{
