========================================================================
       ATL SERVER : Cinco Project Overview
========================================================================

AppWizard has created this Cinco application for you.  This application
not only demonstrates the basics of using the ATL Server Classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Cinco application.
...
Cinco.srf
	...
	associated with the OnHello method in the CCincoHandler class.
