	...
	)
{
	...
	memcpy_s(__params.arIn, sizeof(__params.arIn), arIn, 2*sizeof(int));
	...
	memcpy_s(__retval, sizeof(__retval), __params.__retval, 2*sizeof(int));
	goto __skip_cleanup;
...
{
	static const _soapmapentry __CComplexTypesService_sample_fixedSize_Array_atlsoapheader_entries[] =
	{
		{ 0x00000000 }
	};

	static const _soapmap __CComplexTypesService_sample_fixedSize_Array_atlsoapheader_map = 
	{
		0x562996EA,
		"sample_fixedSize_Array",
		L"sample_fixedSize_Array",
	...
	static const _soapmapentry __CComplexTypesService_sample_dynamicSize_Array_atlsoapheader_entries[] =
	{
		{ 0x00000000 }
	};

	static const _soapmap __CComplexTypesService_sample_dynamicSize_Array_atlsoapheader_map = 
	{
		0x788BB39F,
		"sample_dynamicSize_Array",
		L"sample_dynamicSize_Array",
	...
	static const _soapmapentry __CComplexTypesService_sample_NestedStruct_atlsoapheader_entries[] =
	{
		{ 0x00000000 }
	};

	static const _soapmap __CComplexTypesService_sample_NestedStruct_atlsoapheader_map = 
	{
		0x6FE718C9,
		"sample_NestedStruct",
		L"sample_NestedStruct",
	...
	static const _soapmapentry __CComplexTypesService_sample_struct_atlsoapheader_entries[] =
	{
		{ 0x00000000 }
	};

	static const _soapmap __CComplexTypesService_sample_struct_atlsoapheader_map = 
	{
		0xC10A6386,
		"sample_struct",
		L"sample_struct",
	...
	static const _soapmapentry __CComplexTypesService_sample_structArray_atlsoapheader_entries[] =
	{
		{ 0x00000000 }
	};

	static const _soapmap __CComplexTypesService_sample_structArray_atlsoapheader_map = 
	{
		0x236C3525,
		"sample_structArray",
		L"sample_structArray",
	...
	static const _soapmapentry __CComplexTypesService_sample_NestedArray_atlsoapheader_entries[] =
	{
		{ 0x00000000 }
	};

	static const _soapmap __CComplexTypesService_sample_NestedArray_atlsoapheader_map = 
	{
		0x9D440D63,
		"sample_NestedArray",
		L"sample_NestedArray",
	...
	static const _soapmap * __CComplexTypesService_headers[] =
	{
...
inline HRESULT AtlCleanupValue<ComplexTypesService::stComplex>(ComplexTypesService::stComplex *pVal)
{
    ...
    hRetVal = AtlCleanupValue(&pVal->iID);
    if (FAILED(hRetVal)) return hRetVal;
	hRetVal = AtlCleanupValue(&pVal->bstrData);
    return hRetVal;
}
...
inline HRESULT AtlCleanupValueEx<ComplexTypesService::stComplex>(ComplexTypesService::stComplex *pVal, IAtlMemMgr *pMemMgr)
{
	...
	hRetVal = AtlCleanupValueEx(&pVal->iID, pMemMgr);
    if (FAILED(hRetVal)) return hRetVal;
	hRetVal = AtlCleanupValueEx(&pVal->bstrData, pMemMgr);
    return hRetVal;
}
...
inline HRESULT AtlCleanupValue<ComplexTypesService::stNested>(ComplexTypesService::stNested *pVal)
{
    ...
    hRetVal = AtlCleanupValue(&pVal->iExtValue);
    if (FAILED(hRetVal)) return hRetVal;
	hRetVal = AtlCleanupValue(&pVal->innerStruct);
    return hRetVal;
}
...
inline HRESULT AtlCleanupValueEx<ComplexTypesService::stNested>(ComplexTypesService::stNested *pVal, IAtlMemMgr *pMemMgr)
{
	...
	hRetVal = AtlCleanupValueEx(&pVal->iExtValue, pMemMgr);
    if (FAILED(hRetVal)) return hRetVal;
	hRetVal = AtlCleanupValueEx(&pVal->innerStruct, pMemMgr);
    return hRetVal;
}
...
inline HRESULT AtlCleanupValue<ComplexTypesService::stEmbeddedArr>(ComplexTypesService::stEmbeddedArr *pVal)
{
    ...
    hRetVal = AtlCleanupValue(&pVal->bstrVal);
    if (FAILED(hRetVal)) return hRetVal;
	hRetVal = AtlCleanupValue(&pVal->nCount);
    if (FAILED(hRetVal)) return hRetVal;
	hRetVal = AtlCleanupArray(pVal->arValues, pVal->nCount);
    return hRetVal;
}
...
inline HRESULT AtlCleanupValueEx<ComplexTypesService::stEmbeddedArr>(ComplexTypesService::stEmbeddedArr *pVal, IAtlMemMgr *pMemMgr)
{
	...
	hRetVal = AtlCleanupValueEx(&pVal->bstrVal, pMemMgr);
    if (FAILED(hRetVal)) return hRetVal;
	hRetVal = AtlCleanupValueEx(&pVal->nCount, pMemMgr);
    if (FAILED(hRetVal)) return hRetVal;
	if (pVal->arValues != NULL)
	{
		hRetVal = AtlCleanupArrayEx(pVal->arValues, pVal->nCount, pMemMgr);
        if (FAILED(hRetVal)) return hRetVal;
		pMemMgr->Free(pVal->arValues);
	}
	return S_OK;
}
