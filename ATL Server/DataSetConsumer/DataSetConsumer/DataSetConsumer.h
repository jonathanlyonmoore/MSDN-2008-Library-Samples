...
//=====================================================================================
		WebService1Class::CWebService1ClassT<CSoapSocketClientT<> > *myService =
			new WebService1Class::CWebService1ClassT<CSoapSocketClientT<> > ();
...
//=====================================================================================
		...
		CComBSTR bstrFrag;
		CStringW xmlStr(bstrXML);
		
		int srcLen = xmlStr.GetLength();
		int destLen = EscapeXML(xmlStr,srcLen,0,0);
		wchar_t *pEscXML = new wchar_t[destLen+1];

		EscapeXML(xmlStr,srcLen,pEscXML,destLen);

		bstrFrag.Append(L"<DataSetFrag>");
		bstrFrag.Append(pEscXML);
		bstrFrag.Append(L"</DataSetFrag>");
