...
{
	static const _soapmapentry __CSecureValidationService_validateUser_atlsoapheader_entries[] =
	{
		{ 0x00000000 }
	};

	static const _soapmap __CSecureValidationService_validateUser_atlsoapheader_map = 
	{
		0x1E401F69,
		"validateUser",
		L"validateUser",
	...
	static const _soapmap * __CSecureValidationService_headers[] =
	{
