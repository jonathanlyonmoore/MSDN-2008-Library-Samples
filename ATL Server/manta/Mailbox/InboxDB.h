...
{
public:
	[ db_column(ordinal="1") ] TCHAR m_szFrom[DB_MAX_STRLEN + 1];
	[ db_column(ordinal="2") ] TCHAR m_szDate[DB_MAX_STRLEN + 1];
	[ db_column(ordinal="3") ] TCHAR m_szSubject[DB_MAX_STRLEN + 1];
...
{
	public:
	[ db_column(ordinal="1") ] LONG m_lNewMessageCount;
	[ db_param("1") ] LONG m_lUserID;
};
...
{
public:
	[ db_column(ordinal="1") ] TCHAR m_szPopServer[DB_MAX_STRLEN + 1];
	[ db_column(ordinal="2") ] LONG m_lPopPort;
	[ db_column(ordinal="3") ] TCHAR m_szPopUserName[DB_MAX_STRLEN + 1];
	[ db_column(ordinal="4") ] TCHAR m_szPopPassword[DB_MAX_STRLEN + 1];
	[ db_param("1") ] LONG m_lUserID;
};
