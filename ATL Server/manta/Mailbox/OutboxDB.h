...
{
public:
	[ db_column(ordinal="1") ] TCHAR m_szTo[DB_MAX_STRLEN + 1];
...
class COutboxMessages
{
	public:
	[ db_column(ordinal="1") ] TCHAR m_szTo[DB_MAX_STRLEN + 1];
	[ db_column(ordinal="2") ] TCHAR m_szFrom[DB_MAX_STRLEN + 1];
	[ db_column(ordinal="3") ] TCHAR m_szSubject[DB_MAX_STRLEN + 1];
	[ db_column(ordinal="4") ] TCHAR m_szDate[DB_MAX_STRLEN + 1];
	[ db_column(ordinal="5") ] TCHAR m_szMessage[MAX_MSG_LENGTH + 1];
	[ db_column(ordinal="6") ] LONG m_lMessageID;
	[ db_param("1") ]	LONG m_lUserID;
};
