...
[
	uuid("BAB8C31E-2915-4D45-BD07-FA3A9F4482CC"), 
	object
]
...
[
	request_handler(name="Default", sdl="GenWeatherServiceWSDL"),
	soap_handler(
		name="WeatherService", 
		namespace="urn:WeatherServiceService",
		protocol="soap"
	)
]
...
protected:
	int FindCity(BSTR cityname)
	{
		...
		{
			if (!_wcsicmp(cityname,g_SampleData[i].szCityName))
				return i;
		}
		return -1;
	}
