...
CPP=cl.exe
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /ZI /Od /D "_DEBUG" /D "_USRDLL" /D "WIN32" /D "_WINDOWS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\ATLTangramCanvas.pch" /Yu"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib opengl32.lib glu32.lib glaux.lib /nologo /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\ATLTangramCanvas.pdb" /debug /machine:I386 /out:"$(OUTDIR)\ATLTangramCanvas.dll" /implib:"$(OUTDIR)\ATLTangramCanvas.lib" /pdbtype:sept /idlout:_atltangramcanvas.idl 
LINK32_OBJS= \
...
ALL : "$(OUTDIR)\ATLTangramCanvas.dll" ".\Release\regsvr32.trg"

!ELSE 

ALL : "ATLModel - Win32 Release" "$(OUTDIR)\ATLTangramCanvas.dll" ".\Release\regsvr32.trg"
...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /O1 /D "NDEBUG" /D "_ATL_DLL" /D "WIN32" /D "_WINDOWS" /Fp"$(INTDIR)\ATLTangramCanvas.pch" /Yu"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\ATLTangramCanvas.pdb" /machine:I386 /out:"$(OUTDIR)\ATLTangramCanvas.dll" /implib:"$(OUTDIR)\ATLTangramCanvas.lib" /idlout:_atltangramcanvas.idl 
LINK32_OBJS= \
	"$(INTDIR)\ATLTangramCanvas.obj" \
	"$(INTDIR)\AtlTangramCanvasImpl.obj" \
	"$(INTDIR)\StdAfx.obj" \
...
"$(INTDIR)\ATLTangramCanvas.obj"	"$(INTDIR)\ATLTangramCanvas.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\ATLTangramCanvas.pch"
...
"$(INTDIR)\ATLTangramCanvas.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) $(RSC_PROJ) $(SOURCE)
...
"$(INTDIR)\AtlTangramCanvasImpl.obj"	"$(INTDIR)\AtlTangramCanvasImpl.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\ATLTangramCanvas.pch"
...
CPP_SWITCHES=/nologo /MTd /W3 /Gm /GX /ZI /Od /D "_DEBUG" /D "_USRDLL" /D "WIN32" /D "_WINDOWS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\ATLTangramCanvas.pch" /Yc"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP_SWITCHES=/nologo /MT /W3 /GX /O1 /D "NDEBUG" /D "_ATL_DLL" /D "WIN32" /D "_WINDOWS" /Fp"$(INTDIR)\ATLTangramCanvas.pch" /Yc"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
"ATLModel - Win32 Debug" : 
   cd "\samples\attrib\atltangram\ATLModel"
