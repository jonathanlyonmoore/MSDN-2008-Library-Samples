...
CPP=cl.exe
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\ATLModel" /I "..\ATLTangramCanvas" /I "..\\" /I "..\ATLGdiWorld" /D "_DEBUG" /D "_USRDLL" /D "WIN32" /D "_WINDOWS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\AtlGLWorld.pch" /Yu"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib opengl32.lib glu32.lib glaux.lib /nologo /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\AtlGLWorld.pdb" /debug /machine:I386 /out:"$(OUTDIR)\AtlGLWorld.dll" /implib:"$(OUTDIR)\AtlGLWorld.lib" /pdbtype:sept /idlout:_atlglworld.idl 
LINK32_OBJS= \
...
ALL : "$(OUTDIR)\AtlGLWorld.dll" ".\Release\regsvr32.trg"

!ELSE 

ALL : "ATLGdiWorld - Win32 Release" "$(OUTDIR)\AtlGLWorld.dll" ".\Release\regsvr32.trg"
...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /O1 /I "..\ATLModel" /I "..\ATLTangramCanvas" /I "..\\" /I "..\ATLGdiWorld" /D "NDEBUG" /D "_ATL_DLL" /D "WIN32" /D "_WINDOWS" /Fp"$(INTDIR)\AtlGLWorld.pch" /Yu"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib opengl32.lib glu32.lib glaux.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\AtlGLWorld.pdb" /machine:I386 /out:"$(OUTDIR)\AtlGLWorld.dll" /implib:"$(OUTDIR)\AtlGLWorld.lib" /idlout:_atlglworld.idl 
LINK32_OBJS= \
	"$(INTDIR)\AtlGLWorld.obj" \
	"$(INTDIR)\AtlGLWorldImpl.obj" \
	"$(INTDIR)\AtlTangramGLVisual.obj" \
...
"$(INTDIR)\AtlGLWorld.obj"	"$(INTDIR)\AtlGLWorld.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\AtlGLWorld.pch"
...
"$(INTDIR)\AtlGLWorld.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) $(RSC_PROJ) $(SOURCE)
...
"$(INTDIR)\AtlGLWorldImpl.obj"	"$(INTDIR)\AtlGLWorldImpl.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\AtlGLWorld.pch"
...
"$(INTDIR)\AtlTangramGLVisual.obj"	"$(INTDIR)\AtlTangramGLVisual.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\AtlGLWorld.pch"
...
CPP_SWITCHES=/nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\ATLModel" /I "..\ATLTangramCanvas" /I "..\\" /I "..\ATLGdiWorld" /D "_DEBUG" /D "_USRDLL" /D "WIN32" /D "_WINDOWS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\AtlGLWorld.pch" /Yc"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP_SWITCHES=/nologo /MT /W3 /GX /O1 /I "..\ATLModel" /I "..\ATLTangramCanvas" /I "..\\" /I "..\ATLGdiWorld" /D "NDEBUG" /D "_ATL_DLL" /D "WIN32" /D "_WINDOWS" /Fp"$(INTDIR)\AtlGLWorld.pch" /Yc"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
"ATLGdiWorld - Win32 Debug" : 
   cd "\samples\attrib\atltangram\ATLGdiWorld"
