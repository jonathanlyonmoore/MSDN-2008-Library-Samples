...
function SetupPerfmonData()
{
	...
	if (!PerfMonDisp.Initialize())
	{
		...
		PerfMonDisp.AddCounterDefinition(0, "Frames", "Number of screen refreshes per second", PERF_DETAIL_NOVICE, PERF_COUNTER_COUNTER, 0, 0);
		PerfMonDisp.AddCounterDefinition(0, "Balls Drawn", "number of balls drawn per second displaying the marquee", PERF_DETAIL_NOVICE, PERF_COUNTER_COUNTER, 0, -2);
