...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\ATLModelExe.pdb" /debug /machine:I386 /out:"LocalDebug/ATLModelExe.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\ATLModel.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\ATLModelExe.pdb" /machine:I386 /out:"LocalRelease/ATLModelExe.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ATLModel.obj" \
	"$(INTDIR)\ATLTangramModel.obj" \
	"$(INTDIR)\StdAfx.obj" \
